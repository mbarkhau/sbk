...
## Key Derivation
    ...
    a salt is almost useless. This means that it is not a single point of
    failure and you will have time to rotate your secrets if an attacker
    finds it.
