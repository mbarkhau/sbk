...
cp dist/sbk-2022.1015b0-py3-none-any.whl $BUILD_DIR/
cp dist/sbk-2022.1015b0.tar.gz $BUILD_DIR/
...
# install sbk
ADD sbk-2022.1015b0-py3-none-any.whl /opt/
ADD sbk-2022.1015b0.tar.gz /opt/
RUN mv /opt/sbk-2022.1015b0 /opt/sbk
RUN bash -c "cd /opt; python3 -m pip install sbk-2022.1015b0-py3-none-any.whl"
...
echo 'SBK Live 2022.1015-beta (based on Ubuntu 20.04.2.0 LTS "Focal Fossa" - Release amd64 20210209.1)' > iso/.disk/info
...
-as mkisofs \\
-r -J --joliet-long \\
-V 'SBK Live 2022.1015-beta amd64' \\
...
mv sbklive.iso sbklive_2022.1015-beta-amd64.iso
echo "wrote $BUILD_DIR/sbklive_2022.1015-beta-amd64.iso"

chmod u=rw,g=r,o=r *.iso

rsync --progress sbklive_2022.1015-beta-amd64.iso root@vserver:/var/www/html/sbk/sbk-live

mktorrent \
    --piece-length 22 \
    --announce "udp://tracker.openbittorrent.com:6969/announce" \
    --announce "udp://tracker.opentrackr.org:1337/announce" \
    --web-seed "https://sbk.dev/sbk-live/sbklive_2022.1015-beta-amd64.iso" \
    --output sbklive_2022.1015-beta-amd64.iso.torrent \
    sbklive_2022.1015-beta-amd64.iso
