...
def raw2electrum_seed(int_seed: int, seed_type='standard') -> ElectrumSeed:
    assert int_seed > pow(2, 160)
...
seed = raw2electrum_seed(51567168450570803019617791242210365249640000000000)
print("???", seed)
print("???", mnemonic_decode(seed))
